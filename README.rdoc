...
NOTE: This version is the "Flying Bear" fork which is, for now,
  not meant for public consumption.  Do not ask the XMPP4R list for
  help on changes that I've made and do not ask me for help.

  In the future, I will consider engaging the XMPP4R community,
  such as it is, and merging in changes if they are valuable,
  time permitting.
...
== Contributors
  ...
  Seth Fitzsimmons
  David Árpád Geller <david@socialpicnik.com>
